...
import { EmployeeImageComponent } from './components/employee-image';
import { LoaderComponent } from '../loader.component';

@Component({
  selector: 'employee-details',
  standalone: true,
  imports: [CommonModule, EmployeeImageComponent, LoaderComponent],
  template: `
    ...
    <div>
      {{ employee.title }}, earning {{ employee.salary | currency : 'EUR' }},
      hired: {{ employee.hiredAt | date }}

      <div>office: {{ employee.office.join(', ') }}</div>
